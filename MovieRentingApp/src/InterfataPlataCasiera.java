...
class InterfataPlataCasiera extends Frame{
    Button bPlateste,bInapoiLaListaFilme,bTrimiteCodUnic;
    Panel p1,p2;
    Label l1,l2;
    TextField t1;
    Imprumut i;
    ...
    InterfataPlataCasiera(Imprumut i){
        ...
        l1 = new Label();
        l2 = new Label("Pentru a putea confirma plata,te rugam confirma codul unic pe care ti-l vom trimite ");
        t1 = new TextField(15);
        bPlateste = new Button("Plateste");
        bInapoiLaListaFilme = new Button("Inapoi la lista filmelor");
        bTrimiteCodUnic = new Button("Trimite codul unic");
