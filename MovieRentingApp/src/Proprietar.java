...
class Proprietar implements Comparable<Proprietar>{
    ...
    Proprietar(String numeFilm,String genFilm,String anAparitie,String tipFilm,String nrCopii){
    ...
    @Override
    public int compareTo(Proprietar p1){
